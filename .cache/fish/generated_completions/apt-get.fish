...
complete -c apt-get -l no-list-columns -d 'Display package lists without arranging them in columns'
complete -c apt-get -l comment -d 'Add the given value to the Comment: field in history'
...
complete -c apt-get -l audit -d 'Show audit (and notice) messages'
...
complete -c apt-get -l no-color -l color -d 'Turn colors on or off'
